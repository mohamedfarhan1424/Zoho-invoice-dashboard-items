      ...
      <AppBar position="static" color elevation={1} color="inherit">
        <Toolbar>
          ...
          <div className={styles.righticons}>
            <div>
              <Button><button className={styles.new}>+New</button></Button>
            </div>
            ...
            <Button
              ...
              >
                ...
                <hr/>
                <MenuItem className={classes.menuitem} onClick={handleClose2}>
                <img src="https://img.icons8.com/ios/20/000000/download--v1.png"/> Import Items
                </MenuItem>
                <MenuItem className={classes.menuitem} onClick={handleClose2}>
                <img src="https://img.icons8.com/ios/20/000000/upload--v1.png"/> Export Items
                </MenuItem>
                <hr/>
                <MenuItem className={classes.menuitem} onClick={handleClose2}>
                <img src="https://img.icons8.com/ios/20/000000/upload--v1.png"/> Export Current View
                </MenuItem>
                <hr/>
                <MenuItem className={classes.menuitem} onClick={handleClose2}>
                <img src="https://img.icons8.com/ios-glyphs/20/000000/refresh--v1.png"/> Refresh List
                </MenuItem>
              </Menu>
            </div>

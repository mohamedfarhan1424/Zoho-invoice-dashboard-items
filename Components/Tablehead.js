        ...
        <TableHead>
          <TableRow>
              ...
              >
                <div className={classes.inputs}>
                  {headings.map((item, index) => (
                    <div>
                      <input key={index} type="checkbox" checked={checkedState[index]} onChange={()=>handleSave(index)} />{item}
                      <br />
                    </div>
                  ))}
                </div>
                <div className={classes.savebutton}>
                  <hr />
                  <Button onClick={()=>handleSave(0)} className={classes.save}>Save</Button>{" "}
            ...
            <TableCell align="right">
              <img className={classes.searchicon} src="https://img.icons8.com/material-outlined/24/000000/search--v1.png" />
            </TableCell>
          </TableRow>
        </TableHead>
      </Table>
